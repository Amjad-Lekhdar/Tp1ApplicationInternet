...
<div class="statut view large-9 medium-8 columns content">
    <h3><?= h($statut->name) ?></h3>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($statut->users as $users): ?>
            <tr>
                <td><?= h($users->id) ?></td>
                <td><?= h($users->email) ?></td>
